...
namespace digioz.Portal.Web.Application
{
    public static class Extensions
    {
        ...
        public static MvcHtmlString ForumActionLink(this HtmlHelper htmlHelper, string linkText, string actionName, string forumControllerName)
        {
            // http://stackoverflow.com/questions/2036305/how-to-specify-an-area-name-in-an-action-link
            return htmlHelper.ActionLink(linkText, actionName, forumControllerName, new { area = "Forum" }, new { });
        }

        public static string AdminAction(this UrlHelper urlHelper, string actionName, string adminControllerName)
        {
            // http://stackoverflow.com/questions/2036305/how-to-specify-an-area-name-in-an-action-link
            return urlHelper.Action(actionName, adminControllerName, new { area = "Admin" }, null);
        }  

        //No area, original action behavior
        public static string NoAreaAction(this UrlHelper urlHelper, string actionName, string controllerName)
        {
            // http://stackoverflow.com/questions/2036305/how-to-specify-an-area-name-in-an-action-link
            return urlHelper.Action(actionName, controllerName, new { area = "" }, null);
        }        /// <summary>
      /// <summary>
