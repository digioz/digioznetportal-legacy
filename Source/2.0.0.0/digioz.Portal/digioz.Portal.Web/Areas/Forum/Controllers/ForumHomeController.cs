...
using RssItem = digioz.Portal.Domain.DomainModel.RssItem;
            ...
            using (UnitOfWorkManager.NewUnitOfWork())
            {
                ...
                foreach (var activity in activities)
                {
                    ...
                    else if (activity is MemberJoinedActivity)
                    {
                        ...
                        string avatar = memberJoinedActivity.User.Profiles.First().Avatar;
                        ...
                        rssActivities.Add(new RssItem
                        {
                           ...
                           // RssImage = StringUtils.GetGravatarImage(memberJoinedActivity.User.Profiles.First().Email, AppConstants.GravatarPostSize),
                            RssImage = "~/Content/Avatar/Thumb/" + avatar,
                            Link = activityLink
                        });
                    }
                    else if (activity is ProfileUpdatedActivity)
                    {
                        ...
                        string avatar = profileUpdatedActivity.User.Profiles.First().Avatar;
                        if (string.IsNullOrEmpty(avatar)) { avatar = "Default.png"; }
                     ...
                     //       RssImage = StringUtils.GetGravatarImage(profileUpdatedActivity.User.Profiles.First().Email, AppConstants.GravatarPostSize),
                            RssImage = "~/Content/Avatar/Thumb/" + avatar,
                            Link = activityLink
                        });
                    }
